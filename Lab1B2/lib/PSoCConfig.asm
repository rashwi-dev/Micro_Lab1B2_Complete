...
export LoadConfig_lab1a2
export _LoadConfig_lab1a2
...
;---------------------------------------------------------------------------
; Load Configuration lab1a2
;
;    Load configuration registers for lab1a2.
...
_LoadConfig_lab1a2:
 LoadConfig_lab1a2:
    RAM_PROLOGUE RAM_USE_CLASS_4
    lcall   LoadConfigTBL_lab1a2            ; Call load config table routine
